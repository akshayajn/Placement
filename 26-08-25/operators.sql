...
VALUES ('Alice', 'Johnson', 50000, '2022-05-10', 'HR'),
...
SELECT WorkerID, FirstName, Salary, (Salary * 1.10) AS IncreasedSalary FROM Worker;
SELECT WorkerID, FirstName, Salary, (Salary * 12) AS AnnualSalary FROM Worker;
SELECT * FROM Worker WHERE FirstName LIKE 'A%';
SELECT * FROM Worker WHERE LastName LIKE '%n';
SELECT * FROM Worker WHERE Department LIKE '%Fin%';
SELECT * FROM Worker WHERE Salary BETWEEN 50000 AND 75000;
SELECT * FROM Worker WHERE JoiningDate BETWEEN '2021-01-01' AND '2023-12-31';
SELECT * FROM Worker WHERE WorkerID BETWEEN 2 AND 4;
SELECT * FROM Worker WHERE (Department = 'Finance' AND Salary >= 60000) OR WorkerID = 1;
SELECT * FROM Worker WHERE Salary BETWEEN 50000 AND 75000 OR JoiningDate BETWEEN '2021-01-01' AND '2023-12-31' OR WorkerID BETWEEN 2 AND 4;
